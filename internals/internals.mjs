...
const STATIC_ASSETS = [
  ...
  'http://127.0.0.1:5502/utils.css',
  'http://127.0.0.1:5502/utils.js',
  'http://127.0.0.1:5502/tooltip.js',
  'http://127.0.0.1:5502/utils.mjs',
  'http://127.0.0.1:5502/reorder.mjs',
  'http://127.0.0.1:5502/hinolugi-utils-icon.svg',
  'http://127.0.0.1:5502/hinolugi-utils-icon-512x512.png',
  'http://127.0.0.1:5502/hinolugi-utils-icon-192x192.png',
  'http://127.0.0.1:5502/hinolugi-utils-icon-512x512.png',
